...
The Deliverer is responsible for compiling all the information into the RMarkdown template provided on the course website. This document should be carefully proofread and submitted as an PDF file via Sakai by the due date.  A minimum 2 point penalty will be given, if this document is submitted late. This penalty applies to your entire group.
